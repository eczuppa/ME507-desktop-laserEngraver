 ...
 *  @date 7 Nov 2020  finished first version of motor driver, needs to be updated to accept more refrences 
...
class TB6612FNG 
{
    ...
    uint8_t _motor_dir_pin_1;    ///< Motor Direction Pin 1 (Enables for which direciton the motor will rotate in)
    uint8_t _motor_dir_pin_2;    ///< Motor Direction Pin 2 (Enables for which direciton the motor will rotate in)
