 ...
 *                       nothing instead of the intented ouput ramp element. 
 *  @date    23 Nov 2020 Completed second revision of class, dyanmic allocation of array memory is now done in a separate method and 
 *                       required to have suceeded for the ramp generator method to run. Uses the trick Dr. Ridgely mentioned in 
 *                       lecture of checking that the pointer to the dynamic array points to something instead of zero as an indicator
 *                       that the memory allocation was succesful
