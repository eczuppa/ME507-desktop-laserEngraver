 ...
 *            to hold the ramp input to the control loop. To get an array with a positve integer 
 *            for the index a abreviated approximate version of Euclid's algorithm is used to calculate
 ...
 *             and the dynamic memory allocation was succesful such that the pointer
